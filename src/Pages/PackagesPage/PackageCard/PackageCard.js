...
const PackageCard = (props) => {
    const { _id, package_name, main_picture, price, description, day, reviews_star } = props.s_package
    const navigate = useNavigate();
    const handleCardDetails = (_id) => {
        console.log("clicked");
        navigate(`/singlePackageDetails/${_id}`)
    }
    console.log(_id, package_name, main_picture, price, description, day, reviews_star);
    return (
            ...
            <Card sx={{ maxWidth: "450px", }}>
                ...
                <CardContent>
                    <Box sx={{ display: "flex", alignItems: 'center' }}>
                        <Rating name="read-only" value={parseFloat(reviews_star)} readOnly /><b>9k+ review</b>
                    </Box>
                    ...
                    <Typography variant="h6" component="div" sx={{ display: "flex", justifyContent: "space-between", backgroundColor: '#E8E8E8', borderRadius: "10px", padding: "7px" }}>
                        <span style={{ paddingLeft: "17px" }} >{parseFloat(day)} Days</span>| <span style={{ paddingRight: "17px" }}>Sidney</span>
                    </Typography>
