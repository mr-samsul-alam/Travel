...
// const BookingPackage = ({ dataSubmitted }) => {
//     const { productName } = dataSubmitted || {}
//     const [success, setSuccess] = useState(false)
//     const [person, setPerson] = useState('1');
//     const { user } = useAuth();
//     console.log();
//     const initialInfo = { name: user.displayName, email: user.email, productName: { productName }, phone: '' }
